  ...
  return (
    <div className="bg-[url('assets/bg.png')] bg-cover h-[150vh] w-[99vw] bg-no-repeat text-center" >
        ...
        <div className="mt-12 space-y-4">
          <div className="flex">
              <a href="/disponivel-onlineconsulta" className=" ml-auto mr-4 text-white shadow-md shadow-black text-lg bg-gradient-to-r from-amber-950 to-amber-700 w-40 h-40 border-white border-2 items-center text-center justify-center">
                    <img src={Aries} className="w-20 h-20 ml-auto mr-auto mb-2" alt="aries" />
                    <div>ÁRIES</div>
                    <div className="text-xl font-bold">21/03 E 20/04</div>
              </a>
              

              <a href="/disponivel-onlineconsulta" className="mr-4 text-white shadow-md shadow-black text-lg bg-gradient-to-r from-amber-950 to-amber-700 w-40 h-40 border-white border-2 items-center text-center justify-center">
                  <img src={Touro} className="w-20 h-20 ml-auto mr-auto mb-2" alt="aries" />
                  <div>TOURO</div>
                  <div className="text-xl font-bold">21/04 E 20/05</div>
              </a>
              
              <a href="/disponivel-onlineconsulta" className=" mr-4 text-white shadow-md shadow-black text-lg bg-gradient-to-r from-amber-950 to-amber-700 w-40 h-40 border-white border-2 items-center text-center justify-center">
                  <img src={Gemeous} className="w-20 h-20 ml-auto mr-auto mb-2" alt="aries" />
                  <div>GÊMEOS</div>
                  <div className="text-xl font-bold">21/05 E 20/06</div>
              </a>
              
              <a href="/disponivel-onlineconsulta" className=" mr-auto text-white shadow-md shadow-black text-lg bg-gradient-to-r from-amber-950 to-amber-700 w-40 h-40 border-white border-2 items-center text-center justify-center">
                  <img src={Cancer} className="w-20 h-20 ml-auto mr-auto mb-2" alt="aries" />
                  <div>CÂNCER</div>
                  <div className="text-xl font-bold">21/06 E 21/07</div>
              </a>
          </div>
          <div className="flex">
              <a href="/disponivel-onlineconsulta" className=" ml-auto mr-4 text-white shadow-md shadow-black text-lg bg-gradient-to-r from-amber-950 to-amber-700 w-40 h-40 border-white border-2 items-center text-center justify-center">
                  ...
                  <div>LEÃO</div>
                  <div className="text-xl font-bold">22/07 E 22/08</div>
              </a>

              <a href="/disponivel-onlineconsulta" className="mr-4 text-white shadow-md shadow-black text-lg bg-gradient-to-r from-amber-950 to-amber-700 w-40 h-40 border-white border-2 items-center text-center justify-center">
                  <img src={Vigrem} className="w-20 h-20 ml-auto mr-auto mb-2" alt="aries" />
                  <div>VIRGEM</div>
                  <div className="text-xl font-bold">23/08 E 22/09</div>
              </a>

              <a href="/disponivel-onlineconsulta" className=" mr-4 text-white shadow-md shadow-black text-lg bg-gradient-to-r from-amber-950 to-amber-700 w-40 h-40 border-white border-2 items-center text-center justify-center">
                  <img src={Libra} className="w-20 h-20 ml-auto mr-auto mb-2" alt="aries" />
                  <div>LIBRA</div>
                  <div className="text-xl font-bold">23/09 E 22/10</div>
              </a>

              <a href="/disponivel-onlineconsulta" className=" mr-auto text-white shadow-md shadow-black text-lg bg-gradient-to-r from-amber-950 to-amber-700 w-40 h-40 border-white border-2 items-center text-center justify-center">
                  <img src={Escopiao} className="w-20 h-20 ml-auto mr-auto mb-2" alt="aries" />
                  <div>ESCORPIÃO</div>
                  <div className="text-xl font-bold">23/10 E 21/11</div>
              </a>
          </div>
          <div className="flex">
              <a href="/disponivel-onlineconsulta" className=" ml-auto mr-4 text-white shadow-md shadow-black text-lg bg-gradient-to-r from-amber-950 to-amber-700 w-40 h-40 border-white border-2 items-center text-center justify-center">
