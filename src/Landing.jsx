  ...
  return (
    <div className="bg-[url('assets/fundo.jpg')] bg-cover h-[150vh] w-[99vw] bg-no-repeat text-center" >
        ...
        <div className="mt-12 space-y-4">
          <div className="flex">
              <a href="/chat" className=" ml-auto mr-4 text-white shadow-md shadow-black text-lg bg-gradient-to-r from-amber-950 to-amber-700 w-40 h-40 border-white border-2 items-center text-center justify-center">
              ...
              <a href="/chat" className="mr-4 text-white shadow-md shadow-black text-lg bg-gradient-to-r from-amber-950 to-amber-700 w-40 h-40 border-white border-2 items-center text-center justify-center">
              ...
              <a href="/chat" className=" mr-auto text-white shadow-md shadow-black text-lg bg-gradient-to-r from-amber-950 to-amber-700 w-40 h-40 border-white border-2 items-center text-center justify-center">
